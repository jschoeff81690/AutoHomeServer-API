...
class projects extends controller
{
    ...
    function view ($params = false)
    {
        ...
        if (is_array($params)) {
            ...
            $uid = $_SESSION['uid'];
            $this->app->load_view('view_project', 
                    array(
                            'project' => $project,
                            'user_id' => $uid
                    ));
    ...
    function create ($params = false)
    {
        ...
        if (($step > 1 && ! isset($_SESSION['new_project'])) || $step > 3)
            $step = 1;
    ...
    function _step1 ()
    {
        ...
        if (isset($_POST['project_name'], $_POST['project_description'], 
            ...
            if (isset($_SESSION['project_name'], 
                    $_SESSION['project_description'], $_SESSION['day'], 
                    $_SESSION['month'], $_SESSION['year'])) {
                $data['step'] = 2;
                $this->app->load_view('create_project', $data);
    ...
    function _step3 ()
    {
        ...
        // STEP 3
        //
        if (isset($_POST['finish'], $_POST['company'], $_POST['website'], 
                $_POST['contact'])) {
        ...
        $data = array(
                ...
                'finish' => $_SESSION['year'] . "-" . $_SESSION['month'] . "-" .
                         $_SESSION['day']
        );
    ...
    function add_task ()
    {
        ...
        $response['message'] = "Your task was successfully added."; // false
                                                                     // until
                                                                     // error
                                                                     // encountered
        
        if (isset($_POST['task_name'], $_POST['task_details'], $_POST['month'], 
                $_POST['day'], $_POST['year'], $_POST['project_id'])) {
            // code here
            ...
            if (! empty($_POST['task_name'])) {
                ...
                $data = array(
                        ...
                        'due_date' => $_POST['year'] . "-" . $_POST['month'] .
                                 "-" . $_POST['day']
                );
    ...
    function add_message ()
    {
        $response = array();
        $response['error'] = false; // false until error encounteredvv
        $response['message'] = "Your message was successfully added."; // false
                                                                        // until
                                                                        // error
                                                                        // encountered
