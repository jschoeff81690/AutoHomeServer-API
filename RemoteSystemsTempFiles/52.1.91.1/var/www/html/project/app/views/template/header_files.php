...
<link href="<?php echo base_url;?>assets/css/font-awesome.css"
	rel="stylesheet">
<link href="<?php echo base_url;?>assets/css/jquery.easy-pie-chart.css"
	rel="stylesheet" type="text/css" media="screen">
<link rel="stylesheet"
	href="<?php echo base_url;?>assets/css/owl.carousel.css"
	type="text/css">
<link rel="stylesheet"
	href="<?php echo base_url;?>assets/css/tinycolorpicker.css"
	type="text/css" media="screen" />

<!--<link rel='stylesheet' href='<?php echo base_url;?>assets/css/spectrum.css' />
-->
<!--right slidebar-->
<!--<link href="<?php echo base_url;?>assets/css/slidebars.css"
	rel="stylesheet">
-->
...
<link href="<?php echo base_url;?>assets/css/style-responsive.css"
	rel="stylesheet">
<link href="<?php echo base_url;?>assets/css/xcharts.min.css"
	rel="stylesheet">
